...
//funcion que obtiene los falleras_mayores y los muestra
    //public function obtenerFallera($id){
    //  $conexion = database::conexion();
    //$consulta = "SELECT id_fallera_mayor FROM presidentes_falleras_mayores WHERE id_presidente= :id";
    //$consultaPreparada = $conexion->prepare($consulta);
    //$consultaPreparada->bindValue(':id', $id);
    // $consultaPreparada->execute();
    //obtenemos un array con los id de los falleras_mayores
    //$resultado = $consultaPreparada->fetchAll(PDO::FETCH_ASSOC);
    //mostramos el nombre de los falleras_mayores
    //foreach ($resultado as $value) {
    //    $id = $value["id"];
    //    $fallera = $this->datosfallera($id);
    //    $this->imprimirNombrefallera($id);
    //}
    //}
