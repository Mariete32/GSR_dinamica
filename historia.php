    ...
    <div class="container">
      <div class="row">
        <div class="align-self-center  col-lg-2 col-md-2 col-sm-3 col-3">
          <img src="imagenes/escudo-falla.jpg" class="img-fluid rounded float-center"
...
<p class="text-start  lh-sm m-3">Nostra falla naix en l’any 1888 quan un grup d’amics i veïns se junten 
i decidixen intentar fer una falla en el barri.</p>
 
<p class="text-start lh-sm mx-3">Entre ells trobem a Don Enric Rovira, veí del carrer Guillem Sorolla,
Entre ells trobem a Don Enric Rovira, veí del carrer Guillem Sorolla,
qui en una carta datada el 2 de Març de 1888 li demana a l’Alcalde de Valéncia
un permís per a poder plantar una falla la vespra de Sant Josep
i alegrar el lloc en una banda de música. En eixe precís instant naixia la falla Guillem Sorolla-Recaredo i des d’aquell instant
i exceptuant els anys de la Guerra Civil no hem deixat mai de plantar nostra falla.</p>
 
<p class="text-start lh-sm mx-3">Quan nostre barri era un dels principals de la ciutat de Valéncia per la seua
cèntrica situació,la falla era una de les més importants,
en una gran cantitat de fallers.</p>
 
<p class="text-start lh-sm mx-3">Ya en 1913 guanyarem el 1er Premi de Llibrets de Falla de Lo Rat Penat.
Hem sigut innovadors en un estil de falla en 1933 que deixà al mon de les falles
bocabadat, i en quant naix JCF i otorga premis hem obtingut
un gran número de distincions. </p>
 
<p class="text-start lh-sm mx-3">Artistes reconeguts han plantat en nosatros, grans poetes ens han fet llibrets,
presentacions i inclús en 1962 forem campeons de Valéncia de Truc.
Teatre en Llengua Valenciana, equip de pilota valenciana… en fi, un fum de coses
que han fet de nostra falla un referent en el barri.</p>
 
<p class="text-start lh-sm mx-3">En la década dels 80 i per problemes socials el barri entrà en decadència.
Els veïns començaren a anar-se’n i la falla va patir un colp molt dur quan en més d’una ocasió estiguerem a punt de desfer-la.</p>
 
<p class="text-start lh-sm mx-3">Arribats als 125 anys d’història i ya sense poder soportar la situació economica,
social i estructural decidirem en tot el dolor dels nostres cors
tancar per sempre Guillem Sorolla-Recaredo… Pero com Deu apreta pero no ofega, de colp i repent i gràcies a molta gent que vullgué sumar-se a nostra causa renaixquerem en més força que mai.
Tornem a guanyar premis de falla, tornem a tindre actes per a nosatros 
ya oblidats, tornem a sentir per nostra falla eixa ilusió que ya haviem perdut. Ara es el moment de passar-s’ho be, de tornar a nostra falla al lloc que mereix,
d’animar un barri que tant i tant a patit. De fer-la divertida, senzilla, tradicional i valenciana.</p>
 
<p class="text-start lh-sm mx-3">Ara és el moment que vingues a Guillem Sorolla-Recaredo i conegues això
que ens fa peculiars, nostre sentiment per nostra falla, nostre sentiment
per Guillem Sorolla-Recaredo. </p>

<figcaption class="blockquote-footer text-right">
    <cite title=" Josep Nebot">Josep Nebot.</cite>
  </figcaption>
  </div>
  </div>
