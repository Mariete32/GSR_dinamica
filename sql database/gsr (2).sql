...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-05-2023 a las 15:47:52
...
CREATE TABLE `cuotas` (
  ...
  `cuota_titulo` varchar(30) NOT NULL,
  `cuota_precio` int(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `cuotas` (`cuota_id`, `cuota_titulo`, `cuota_precio`) VALUES
(12, 'ninos_0', 0),
(13, 'ninos_2a4', 30),
(14, 'ninos_4a14', 40),
(15, 'ninos_14_16', 50),
...
(40, 'Raquel', '', '../imagenes/directiva/FMI_Raquel_1996.jpg', 1996, 21);
...
(56, 'Raquel ', 1996, 'FMI_imagen', './imagenes/directiva/FMI_Raquel_2001.jpg'),
(64, '1º secció decimoctava', 2015, 'Premio_imagen', './imagenes/Premios/Premio_1º secció decimoctava_2015.jpg'),
(66, '10º Llibret de falla', 2016, 'Premio_imagen', './imagenes/Premios/Premio_Llibret de falla_2016.jpg'),
(67, '4º secció séptima B', 2016, 'Premio_imagen', './imagenes/Premios/Premio_4º secció séptima B_2016.jpg'),
(68, '2º ingeny i gràcia', 2016, 'Premio_imagen', './imagenes/Premios/Premio_2º ingeny i gràcia_2016.jpg'),
(69, '8º secció decimoséptima', 2016, 'Premio_imagen', './imagenes/Premios/Premio_8º secció decimoséptima_2016.jpg'),
(70, 'Llibret de falla', 2017, 'Premio_imagen', './imagenes/Premios/Premio_Llibret de falla_2017.jpg'),
(71, '7º Llibret de falla', 2017, 'Premio_imagen', './imagenes/Premios/Premio_7º Llibret de falla_2017.jpg');
...
--
ALTER TABLE `cuotas`
  MODIFY `cuota_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `directiva`
--
ALTER TABLE `directiva`
  MODIFY `jun_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `recurso`
  MODIFY `rec_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
