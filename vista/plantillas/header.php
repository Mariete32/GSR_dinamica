      ...
      <div class="container-fluid ">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav mx-5 mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="historia.php">Historia</a>
            </li>
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="premios.php">Premios</a>
            </li>
            <!--
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="eventos.php">Eventos</a>
            </li>
            -->
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="falleras_majores.php">Falleras mayores</a>
            </li>
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="presidentes.php">Presidentes</a>
            </li>
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="monumentos.php">Fallas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="libros.php">Llibrets</a>
            </li>
            <!--
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="directiva.php">Junta directiva</a>
            </li>
            
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="imagenes.php">Himno</a>
            </li>
            -->
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="cuotas.php">Cuotas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link my-2 mx-3 active" aria-current="page" href="contacto.php">Contacto</a>
            </li>
